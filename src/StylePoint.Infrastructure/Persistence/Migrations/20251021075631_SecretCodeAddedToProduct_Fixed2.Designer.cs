...
namespace StylePoint.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251021075631_SecretCodeAddedToProduct_Fixed2")]
    partial class SecretCodeAddedToProduct_Fixed2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StylePoint.Domain.Entities.UserDiscount", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StylePoint.Domain.Entities.UserDiscount", b =>
                {
                    b.HasOne("StylePoint.Domain.Entities.Discount", "Discount")
                        .WithMany("RedeemedUsers")
